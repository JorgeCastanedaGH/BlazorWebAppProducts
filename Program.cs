...
builder.Services.AddDbContextFactory<BlazorWebAppProductsContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("BlazorWebAppProductsContext") ?? throw new InvalidOperationException("Connection string 'BlazorWebAppProductsContext' not found.")));
